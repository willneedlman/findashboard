...
- Only branch off `main` if currently on it; normal work lands on the active feature branch (e.g. `all-features`). End commit bodies with the `Co-Authored-By: Codex Fable 5 <noreply@anthropic.com>` trailer.

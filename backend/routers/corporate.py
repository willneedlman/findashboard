...
_FUND_FIELDS = [
    ...
    ("researchAndDevelopment",      "R&D",                  "$", "Income"),
    ("sellingGeneralAndAdmin",      "SG&A",                 "$", "Income"),
    ("interestExpense",             "Interest expense",     "$", "Income"),
    ...
    ("totalAssets",                 "Total assets",         "$", "Balance"),
    ("totalLiabilities",            "Total liabilities",    "$", "Balance"),
    ("currentAssets",               "Current assets",       "$", "Balance"),
    ("currentLiabilities",          "Current liabilities",  "$", "Balance"),
    ("workingCapital",              "Working capital",      "$", "Balance"),
    ("inventory",                   "Inventory",            "$", "Balance"),
    ("receivables",                 "Receivables",          "$", "Balance"),
    ("propertyPlantEquipment",      "PP&E",                 "$", "Balance"),
    ("goodwill",                    "Goodwill",             "$", "Balance"),
    ("retainedEarnings",            "Retained earnings",    "$", "Balance"),
    ("operatingCashFlow",           "Operating cash flow",  "$", "Cash flow"),
    ("capitalExpenditure",          "Capex",                "$", "Cash flow"),
    ("freeCashFlow",                "Free cash flow",       "$", "Cash flow"),
    ("depreciationAndAmortization", "D&A",                  "$", "Cash flow"),
    ("stockCompensation",           "Stock comp",           "$", "Cash flow"),
    ("changeInWorkingCapital",      "Change in NWC",        "$", "Cash flow"),
    ("investingCashFlow",           "Investing cash flow",  "$", "Cash flow"),
    ("financingCashFlow",           "Financing cash flow",  "$", "Cash flow"),

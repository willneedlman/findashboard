...
function DetailInspector({ selection, data, onSelect, onClose }: { selection: DetailSelection; data: AnalysisResult; onSelect: (selection: DetailSelection) => void; onClose: () => void }) {

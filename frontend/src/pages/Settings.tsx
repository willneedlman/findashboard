...
const PRESETS: { name: string; theme: Partial<Theme> }[] = [
  ...
  { name: 'Emerald Dark',   theme: { primaryColor: '#059669', secondaryColor: '#31aa8a', tertiaryColor: '#6ee7b7', bgColor: '#092f1c', surfaceColor: '#031c0f', chartNeutralColor: '#3a7a5f', primaryFont: 'JetBrains Mono', secondaryFont: 'IBM Plex Sans', primaryFontUrl: '', secondaryFontUrl: '' } },

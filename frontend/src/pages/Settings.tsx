...
const PRESETS: { name: string; theme: Partial<Theme> }[] = [
  ...
  { name: 'Nord',           theme: { primaryColor: '#88c0d0', secondaryColor: '#c0c4ce', tertiaryColor: '#a3be8c', bgColor: '#1e2430', surfaceColor: '#19202c', chartNeutralColor: '#5a8099', primaryFont: 'San Francisco', secondaryFont: 'Sora', primaryFontUrl: '', secondaryFontUrl: '' } },

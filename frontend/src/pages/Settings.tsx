...
const PRESETS: { name: string; theme: Partial<Theme> }[] = [
  ...
  { name: 'Arctic Blue',    theme: { primaryColor: '#38bdf8', secondaryColor: '#64748b', tertiaryColor: '#a78bfa', bgColor: '#0a1020', surfaceColor: '#0d1530', primaryFont: 'JetBrains Mono', secondaryFont: 'IBM Plex Sans', primaryFontUrl: '', secondaryFontUrl: '' } },
  { name: 'Violet Storm',   theme: { primaryColor: '#d946ef', secondaryColor: '#6d28d9', tertiaryColor: '#22d3ee', bgColor: '#07040f', surfaceColor: '#0f0820', primaryFont: 'JetBrains Mono', secondaryFont: 'IBM Plex Sans', primaryFontUrl: '', secondaryFontUrl: '' } },
  { name: 'Cyber Citrus',   theme: { primaryColor: '#facc15', secondaryColor: '#374151', tertiaryColor: '#f43f5e', bgColor: '#030507', surfaceColor: '#070a0f', primaryFont: 'Space Mono',     secondaryFont: 'IBM Plex Sans', primaryFontUrl: '', secondaryFontUrl: '' } },
  ...
  { name: 'Jade Terminal',  theme: { primaryColor: '#00c896', secondaryColor: '#4a6b6a', tertiaryColor: '#00e5ff', bgColor: '#020f0d', surfaceColor: '#071412', primaryFont: 'Source Code Pro', secondaryFont: 'DM Sans',       primaryFontUrl: '', secondaryFontUrl: '' } },
  { name: 'Dusk Copper',    theme: { primaryColor: '#e8845a', secondaryColor: '#7a6658', tertiaryColor: '#f0c080', bgColor: '#120b08', surfaceColor: '#1c100c', primaryFont: 'Inconsolata',     secondaryFont: 'Raleway',       primaryFontUrl: '', secondaryFontUrl: '' } },
  { name: 'Deep Slate',     theme: { primaryColor: '#f472b6', secondaryColor: '#475569', tertiaryColor: '#67e8f9', bgColor: '#080b12', surfaceColor: '#0d1220', primaryFont: 'Roboto Mono',     secondaryFont: 'Nunito Sans',   primaryFontUrl: '', secondaryFontUrl: '' } },
]

...
const PRESETS: { name: string; theme: Partial<Theme> }[] = [
  ...
  { name: 'Emerald Dark',   theme: { primaryColor: '#059669', secondaryColor: '#31aa8a', tertiaryColor: '#6ee7b7', bgColor: '#092f1c', surfaceColor: '#03110a', chartNeutralColor: '#3a7a5f', primaryFont: 'JetBrains Mono', secondaryFont: 'IBM Plex Sans', primaryFontUrl: '', secondaryFontUrl: '' } },
  { name: 'Crimson Night',  theme: { primaryColor: '#e11d48', secondaryColor: '#c99caa', tertiaryColor: '#fda4af', bgColor: '#2c0216', surfaceColor: '#160310', chartNeutralColor: '#7a4870', primaryFont: 'JetBrains Mono', secondaryFont: 'IBM Plex Sans', primaryFontUrl: '', secondaryFontUrl: '' } },
  { name: 'Mainstreet',     theme: { primaryColor: '#a97c50', secondaryColor: '#adadaf', tertiaryColor: '#73a579', bgColor: '#1a1410', surfaceColor: '#231d17', chartNeutralColor: '#8a7a55', primaryFont: 'JetBrains Mono', secondaryFont: 'Barlow',        primaryFontUrl: '', secondaryFontUrl: '' } },
  ...
  { name: 'Rosewood',       theme: { primaryColor: '#881337', secondaryColor: '#5a1c1c', tertiaryColor: '#c47878', bgColor: '#fdf4f4', surfaceColor: '#e8d5d5', chartNeutralColor: '#ff9494', primaryFont: 'JetBrains Mono', secondaryFont: 'Fraunces',     primaryFontUrl: '', secondaryFontUrl: '' } },

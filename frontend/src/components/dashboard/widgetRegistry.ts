...
export const WIDGET_DEFINITIONS: Record<WidgetType, WidgetDefinition> = {
  ...
  'risk-metrics': define('risk-metrics', { name: 'Risk Metrics', icon: 'RSK', category: 'Portfolio', purpose: 'Portfolio volatility, drawdown, and concentration', dataType: 'Metrics and concentration bars', priority: 'primary', preferred: { w: 5, h: 6 }, minimum: { w: 4, h: 6 }, region: 'center', objectives: ['risk', 'portfolio'], compatible: ['factor-decomposition', 'pnl-attribution'], related: ['correlation-matrix', 'pm-portfolios'], conflicts: ['portfolio-summary'], dataSources: ['portfolio manager', 'market history'], configOptions: ['portfolioId', 'benchmark'], defaultConfig: { benchmark: 'SPY' }, description: 'Portfolio VaR, beta, volatility, drawdown, and concentration.' }),
  ...
  'portfolio-summary': define('portfolio-summary', { name: 'Portfolio Summary', icon: 'P', category: 'Portfolio', purpose: 'Compare a model portfolio with a benchmark', dataType: 'Performance chart and metrics', priority: 'secondary', preferred: { w: 6, h: 5 }, minimum: { w: 5, h: 4 }, region: 'body', objectives: ['portfolio', 'research'], conflicts: ['risk-metrics'], dataSources: ['market history'], configOptions: ['tickers', 'weights', 'chartMode'], defaultConfig: { tickers: ['SPY', 'QQQ', 'TLT', 'GLD'], weights: [0.4, 0.3, 0.2, 0.1], chartMode: 'cumulative' }, description: 'Portfolio backtest with CAGR, alpha, Sharpe, drawdown, and rolling beta.' }),

...
export interface PMHolding { ticker: string; shares: number; avgCost: number; useMarketPrice?: boolean; pendingInvestmentAmount?: number; quantityMode?: 'shares' | 'dollars' }

...
export const HUBS: Hub[] = [
  {
    ...
    tools: [
      ...
      { title: 'Earnings Summarizer', chip: 'Earnings Summarizer', desc: 'Call transcripts and filing summaries on demand',       route: '/earnings',           icon: FileText },
      ...
      { title: 'Portfolio Earnings', chip: 'Portfolio Earnings', desc: 'Your holdings counting down to their next report, with valuation, positioning and the wire', route: '/corporate', icon: CalendarClock },
      { title: 'Earnings Scanner', chip: 'Earnings Scanner', desc: 'Confirmed and estimated report dates with past reactions', route: '/earnings-calendar',  icon: CalendarDays },
  ...
  },
  {
    ...
    tools: [
      ...
      { title: 'IV Rank',             chip: 'IV Rank',             desc: 'IV rank and term structure versus history',         route: '/iv-tracker',      icon: Waves },
      { title: 'Volatility Skew',     chip: 'Volatility Skew',     desc: 'Put/call skew and the smile across strikes',        route: '/skew',            icon: CandlestickChart },
  ...
  },
  {
    ...
    tools: [
      ...
      { title: 'Portfolio Optimizer',      chip: 'Portfolio Optimizer', desc: 'Efficient frontier, max-Sharpe, risk parity, and per-holding risk', route: '/portfolio-optimizer', icon: PieChart },
      { title: 'Portfolio Builder',        chip: 'Portfolio Builder', desc: 'Deploy cash across tickers with linked weight sliders, then send it to Portfolio Manager', route: '/portfolio-builder', icon: SlidersHorizontal },
      ...
      { title: 'Portfolio Manager',        chip: 'Portfolio Manager', desc: 'Holdings, P&L, and portfolio-level greeks', route: '/portfolio-manager', icon: Briefcase },

import {
  ...
  Filter, TrendingUp, Brain, FileSearch, FileText, Activity,
...
export const HUBS: Hub[] = [
  {
    ...
    tools: [
      ...
      { title: 'Filings & Fundamentals',chip: 'Filings',         desc: 'SEC filings, financials, and AI summaries',                route: '/research-hub',             icon: FileSearch },
      { title: 'Earnings AI',           chip: 'Earnings AI',     desc: 'Call transcripts and filing summaries on demand',          route: '/earnings',                 icon: FileText },
      { title: 'Regression',            chip: 'Regression',      desc: 'OLS, correlation, and beta vs any benchmark',              route: '/regression',               icon: Activity },
      ...
      { title: 'Company Profile',       chip: 'Company Profile', desc: 'Revenue mix, supply chain, and geography',                 route: '/research-hub?tab=profile', icon: Globe },
      { title: 'Peer Comparison',       chip: 'Peers',           desc: 'Trading multiples versus sector peers',                    route: '/research-hub?tab=peers',   icon: Scale },
    ],
  },
  {
    slug: 'valuation',
  ...
  },
  {
    ...
    icon: Compass,
    tools: [
      { title: 'Fed Rates',      chip: 'Fed Rates',      desc: 'Implied FOMC path and the full yield curve',     route: '/fed',            icon: GitBranch },

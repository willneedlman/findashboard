...
export const HUBS: Hub[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { title: 'Portfolio Analysis',       chip: 'Analysis',      desc: 'Sectors, alpha, beta, drawdowns, and 500-path portfolio scenarios in one view', route: '/portfolio-analysis', icon: ClipboardList },

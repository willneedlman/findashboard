...
const SOURCE_META: Record<ReportResearchSourceId, Omit<ReportResearchSource, 'reason' | 'targets' | 'critical'>> = {
  ...
  'peer-valuation': { id: 'peer-valuation', label: 'Peer valuation', tool: 'Peer Comparison', route: '/peer-comparison', domain: 'issuer' },
  ...
  'dealer-gex': { id: 'dealer-gex', label: 'Dealer gamma', tool: 'Dealer Exposure', route: '/dealer-exposure', domain: 'issuer' },
